...
module.export("osu_to_lua", function(osu_contents) {
    ...
    append(format("   AudioMinBPM = %d,  -- Calculate itself in ServerScript", 0))
    append(format("   AudioMaxBPM = %d,", 0))
    append("")
    append("   -- Metadata")
    ...
    append(format("   KeyCount = %d,", beatmap.difficulty.circleSize))
    append(format("   Stars = %d, -- Manually add this", 0))
    append(format("   OverallDifficulty = %d,", beatmap.difficulty.overallDifficulty))
    append("")
